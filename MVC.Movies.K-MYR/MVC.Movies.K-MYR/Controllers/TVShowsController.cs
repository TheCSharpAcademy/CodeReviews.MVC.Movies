...
namespace MVC.Movies.K_MYR.Controllers
{
    public class TVShowsController : Controller
    {
        ...
        {
            int minYear = _context.TVShows.Min(m => m.ReleaseDate.Year);
            int maxYear = _context.TVShows.Max(m => m.ReleaseDate.Year);
            decimal minPrice = _context.TVShows.Min(m => m.Price);
            decimal maxPrice = _context.TVShows.Max(m => m.Price);
